...
def app(df, X, y):
    ...
    st.markdown(
        """
            <p style="font-size:25px">
                This app uses <b style="color:yellow">Random Forest Classifier</b> for the Prediction of <b style="color:orange">Tuberculosis severity</b>.
            </p>
    ...
    if st.button("Detect Possibilities"):
